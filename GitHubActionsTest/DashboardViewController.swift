...
class DashboardViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @objc private func refreshData() {
        loadData(); refreshControl.endRefreshing()
    }
    ...
    private func showError(_ error: UserValidationError) {
        ...
        case let .ageTooYoung(min): msg = "Must be at least \(min)"
...
extension DashboardViewController: UISearchBarDelegate {
    ...
    func searchBarCancelButtonClicked(_ searchBar: UISearchBar) {
        searchBar.text = ""; isSearching = false; filteredUsers = []; loadData(); searchBar.resignFirstResponder()
    }
}
